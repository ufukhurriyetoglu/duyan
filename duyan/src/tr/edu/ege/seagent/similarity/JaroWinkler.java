package tr.edu.ege.seagent.similarity;
...
public class JaroWinkler implements Comparator {
	...
	private static final double JARO_WINKLER_THRESHOLD = 0.95;
	...
	public String mostSimilarString(String realStr, String testedStr) {
		String selectedStr = "";
		double similarity = new JaroWinkler().similarity(realStr, testedStr);
		if (similarity > JARO_WINKLER_THRESHOLD) {
			selectedStr = realStr;
		} else {
			selectedStr = testedStr;
		}
		return selectedStr;
	}
	...
	public static void main(String[] args) {
		System.out.println("The most : "
				+ new JaroWinkler().mostSimilarString("Kemal Kılıçdaroğlu","Kemal Klıçdaroğlu"));
	}
}